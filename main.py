...
def home():
    ...
    return render_template("index.html", dashboard1 = pic1, dashboard2 = pic2, dashboard3 = pic3, dashboard4 = pic4, dashboard5 = pic5, dashboard6 = pic6)
...
def result():
    ...
    pic5 = os.path.join(app.config['UPLOAD_FOLDER'], 'Dashboard5.png')
    pic6 = os.path.join(app.config['UPLOAD_FOLDER'], 'Dashboard6.png')
    return render_template('index.html', name = name, dashboard1 = pic1, dashboard2 = pic2, dashboard3 = pic3, dashboard4 = pic4, dashboard5 = pic5, dashboard6 = pic6, type = type)
...
def run_prediction(seed):
    ...
    for label in labels:
        ...
        print(string)
        text = generate_text(model, start_string=string)
        full_text = full_text + ".\n " + text
    return full_text
